...
// StripEphemeral ensures that ephemeral tcp connections
// stay in memeory only by removing both tcp and web handlers
// where the Ephemeral field is set to true.
